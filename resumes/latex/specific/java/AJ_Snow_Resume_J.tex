...
%----------HEADING----------
\textbf{\scshape \Large \textcolor{magic_blue}{Albert "AJ" Snow}} \\ \vspace{3pt}
...
\textbf{ Skills}{: }
Software Architecture, Database Design, API Design, Project Modeling, Algorithm Analysis, ETL, OOP, MVC, Functional Programming, Software Testing

\resumeItemListStart
    \resumeItem{ Testing course in college included coursework using tooling such as Jenkins and Selenium }
    \resumeItem{ Exposure to Maven and experience with the JVM via my time with Clojure }
\resumeItemListEnd
