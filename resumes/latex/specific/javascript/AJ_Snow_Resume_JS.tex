...
\begin{onehalfspace}
    ...
    \textbf{ Languages}{: Clojure, JavaScript, PHP, Java, C\#, Rust, Python } \\

    \textbf{ Tools/Frameworks/Libraries}{: MongoDB, Node.js, Docker, Express, JUnit, Typescript, MySQL, GCP, React, Kubernetes } \\
\end{onehalfspace}

    \hangindent=3.6em
    \textbf{ Skills}{: }
    Microservices, Software Architecture, Database Design, API Design, Project Modeling, Algorithm Analysis, ETL, OOP, 
MVC, Functional Programming, Testing
...
\begin{minipage}[t]{0.28\textwidth}
    \raggedright
    \textbf{ Flower Website }\textit{(Typescript)} \\
\end{minipage}
\hfill
\begin{minipage}[t]{0.70\textwidth}
    \raggedright
    |\textit{ Final project for website design class. Written in Typescript. } \\
\end{minipage}
