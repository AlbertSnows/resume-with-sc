...
\begin{minipage}[t]{0.70\textwidth}
    \raggedright
    |\textit{ A fun website using ClojureScript and the Fulcro framework for personal use} \\
\end{minipage}

\begin{minipage}[t]{0.28\textwidth}
  \raggedright
  \textbf{ ShapeToy }\textit{(JS)} \\
\end{minipage}
\hfill
\begin{minipage}[t]{0.70\textwidth}
  \raggedright
  |\textit{ HTML5/JS project interfacing with the Canvas API to keep track of basic shapes } \\
\end{minipage}
