...
\hangindent=3.6em
\textbf{ Skills}{: }
SDLC, Self-Directing, Microservices, Software Architecture, Database Design, 
API/REST,  ETL, 
OOP, CI/CD, Agile
MVC, Functional Programming, Software Testing, 
DevOps, Polygot, Self-Motivated, Quick Learner, Collaborative
...
\resumeSubHeadingListStart
\resumeSubheading
{Software Engineer 2.5}{June 2019 – March 2022}
{Paycom}{}
\resumeItemListStart
