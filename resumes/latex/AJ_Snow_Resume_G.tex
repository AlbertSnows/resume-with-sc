...
\hangindent=3.6em
\textbf{ Skills}{: }
Software Architecture, Database Design, API Design, Project Modeling,
Algorithm Analysis, CI/CD,
MVC, Functional-Programming, Microservices, ETL, OOP, TDD
...
\resumeSubheading
{Back-End Engineer}{May 2022 - June 2023}
{Peerspace}{}
\resumeItemListStart
...
\begin{minipage}[t]{0.70\textwidth}
  \raggedright
  |\textit{ Exploratory projects in spring boot; I also implemented pattern matching in Java } \\
\end{minipage}
