...
{Paycom}{}
\resumeItemListStart
\resumeItem{ Developed new software features in an enterprise, MVSC style framework leveraging OOP style architecture}
  ...
  \resumeItem{ Opened new revenue streams or enhanced existing ones by extending backend APIs, writing user-facing scripts, and adding new workflows }
